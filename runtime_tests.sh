#!/bin/bash
# Runtime / System / Invariant Tests для market_bot
# Все тесты безопасны для production (НЕ торгуют, НЕ слают сигналы)

set -e  # Остановка при первой ошибке

echo "🧪 Запуск Runtime/System/Invariant тестов для market_bot"
echo "=================================================="
echo ""
...
# ============================================================================
echo "1️⃣ Тест: MarketState / Enum Invariants"
python3 - <<EOF
import sys
...
# ============================================================================
echo ""
echo "2️⃣ Тест: SignalSnapshot Integrity"
python3 - <<EOF
import sys
...
# ============================================================================
echo ""
echo "3️⃣ Тест: Gatekeeper Decision Flow"
python3 - <<EOF
import sys
from datetime import datetime, UTC
from core.signal_snapshot import SignalSnapshot, SignalDecision, RiskLevel
...
# ============================================================================
echo ""
echo "4️⃣ Тест: MetaDecisionBrain (WHEN NOT TO TRADE)"
python3 - <<EOF
import sys
...
# ============================================================================
echo ""
echo "5️⃣ Тест: PositionSizer Safety"
python3 - <<EOF
import sys
import math
...
# ============================================================================
echo ""
echo "6️⃣ Тест: PortfolioBrain Exposure Rules"
python3 - <<EOF
import sys
from datetime import datetime, UTC
from core.signal_snapshot import SignalSnapshot, SignalDecision, RiskLevel
...
# ============================================================================
echo ""
echo "7️⃣ Тест: ReplayEngine Isolation Test"
python3 - <<EOF
import sys
...
# ============================================================================
echo ""
echo "8️⃣ Тест: DriftDetector Safety Test"
python3 - <<EOF
import sys
from datetime import datetime, UTC, timedelta
...
# ============================================================================
echo ""
echo "9️⃣ Тест: Runtime Loop Safety (Dry Mode)"
python3 - <<EOF
import sys
import os
...
# ============================================================================
echo ""
echo "🔟 Тест: Full Ecosystem Smoke Test"
python3 - <<EOF
import sys
import time
from datetime import datetime, UTC
